...
import com.la.customview.SmartCameraView.SmartCameraView;
...
public class SmartCameraTestActivity extends AppCompatActivity {

    private static String TAG = SmartCameraTestActivity.class.getSimpleName();
...
//	MagicFilterType magicType = MagicFilterType.SUNRISE;
    ...
    private void initListener() {
        ...
        beautyTypeSelector.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
