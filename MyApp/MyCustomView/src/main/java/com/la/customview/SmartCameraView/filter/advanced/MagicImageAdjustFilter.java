...
import com.la.customview.SmartCameraView.filter.base.MagicBaseGroupFilter;
import com.la.customview.SmartCameraView.filter.base.gpuimage.GPUImageBrightnessFilter;
import com.la.customview.SmartCameraView.filter.base.gpuimage.GPUImageContrastFilter;
import com.la.customview.SmartCameraView.filter.base.gpuimage.GPUImageExposureFilter;
import com.la.customview.SmartCameraView.filter.base.gpuimage.GPUImageFilter;
import com.la.customview.SmartCameraView.filter.base.gpuimage.GPUImageHueFilter;
import com.la.customview.SmartCameraView.filter.base.gpuimage.GPUImageSaturationFilter;
import com.la.customview.SmartCameraView.filter.base.gpuimage.GPUImageSharpenFilter;
