package com.la.myai.ai.mobile_detect;
...
public class MobileDetectFragment extends Fragment {

    private View view;
    private Activity activity;
    private Context context;
    private MobileDetect.Callback callback;
    ...
    public MobileDetectFragment(MobileDetect.Callback callback){
    ...
    private void initTensorFlowAndLoadModel() {
        executor.execute(new Runnable() {
            ...
            public void run() {
                try {
                    classifier = MobileDetectClassifier.create(
                            activity.getAssets(),
                            MODEL_FILE,
                            LABEL_FILE,
                            INPUT_SIZE,
